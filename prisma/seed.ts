  ...
  const products = await Promise.all([
    prisma.product.create({
      data: {
        ...
        stock: 5,
        images: JSON.stringify(['https://picsum.photos/seed/gold1/400/400']),
    ...
    prisma.product.create({
      data: {
        ...
        stock: 3,
        images: JSON.stringify(['https://picsum.photos/seed/gold2/400/400']),
    ...
    prisma.product.create({
      data: {
        ...
        finalPrice: 68000000,
        stock: 1,
        images: JSON.stringify(['https://picsum.photos/seed/gold3/400/400']),
    ...
    prisma.product.create({
      data: {
        ...
        stock: 10,
        images: JSON.stringify(['https://picsum.photos/seed/gold4/400/400']),
